...
import com.ecommerce.ea.interfaces.IThemeSetting;
import com.ecommerce.ea.repository.ThemeSettingRepository;
...
public class ThemeSettingService implements IThemeSetting {
    ...
    ///Edits the Setting that is active in a store and it is marked as inactive (FALSE)
    @Override
